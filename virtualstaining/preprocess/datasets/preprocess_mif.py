...
class preprocess_mif:
    def __init__(self, alpha=0.5, in_size=256, out_size=16, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225)):
        ...
        self.max_pool_4times = make_max_pooling(self.in_size, self.out_size)
        self.avg_pool_4times = make_avg_pooling(self.in_size, self.out_size)
...
class preprocess_mif_wotransform:
    def __init__(self, alpha=0.5, in_size=256, out_size=16):
        self.out_size = out_size
        self.in_size = in_size
        self.alpha = alpha
        self.max_pool_4times = make_max_pooling(self.in_size, self.out_size)
