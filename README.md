...
| :---: | :---: | :---: | :---: |
| `Pandora-N` | ConvNeXt V2-Nano | ~15M | [`Pandora_N.pt`](https://huggingface.co/ThoroughFuture/pandora/resolve/main/pandora_B.pt) |
| `Pandora-T` | ConvNeXt V2-Tiny | ~28M | [`Pandora_T.pt`](https://huggingface.co/ThoroughFuture/pandora/resolve/main/pandora_B.pt) |
| `Pandora-B` | ConvNeXt V2-Base | ~89M | [`Pandora_B.pt`](https://huggingface.co/ThoroughFuture/pandora/resolve/main/pandora_B.pt) |
| `Pandora-L` | ConvNeXt V2-Large | ~198M | [`Pandora_L.pt`](https://huggingface.co/ThoroughFuture/pandora/resolve/main/pandora_B.pt) |
| `Pandora-H` | ConvNeXt V2-Huge | ~659M | [`Pandora_H.pt`](https://huggingface.co/ThoroughFuture/pandora/resolve/main/pandora_B.pt) |
